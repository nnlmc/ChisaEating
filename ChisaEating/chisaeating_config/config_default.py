...
CONFIG_DEFAULT: Dict[str, GSC] = {
    ...
    "world5_name": GsStrConfig("世界5名称", "", "崩坏：星穹铁道"),
    "world5_aliases": GsListStrConfig("世界5别名", "", ["星穹铁道", "星铁", "翁法罗斯"]),
    "world5_selfnames": GsListStrConfig("世界5推荐官自称池", "", ["列车长", "帕姆"]),
    "world5_food_text": GsListStrConfig("世界5文字食物池", "", ["列车组便当", "匹诺康尼糖球", "星际和平餐盒"]),
    "world5_drink_text": GsListStrConfig("世界5文字饮品池", "", ["苏乐达", "列车特调咖啡", "梦境饮料"]),
    "world5_dark_text": GsListStrConfig("世界5文字黑暗料理池", "", ["虚数泡面", "忆质炖汤"]),
